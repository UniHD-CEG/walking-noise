...
class CIFAR10():
    ...
    def prepare_data(self) -> None:
        torch_CIFAR10(root=self.data_root, train=True, download=True)
        torch_CIFAR10(root=self.data_root, train=False, download=True)

    def setup(self) -> None:
        self.train_set = torch_CIFAR10(
            root=self.data_root, train=True,
            download=False, transform=self.transform_train)
        self.val_set = torch_CIFAR10(
